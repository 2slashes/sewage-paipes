...
def parse_all():
    ...
    states_dir: str = "planning/states"
    include_header = True
            ...
            if dir_name.is_dir() and dir_name.name.isdigit():
                ...
                for solution_file in os.listdir(dir_name):
                    ...
                    if match:
                        ...
                        state_file_path = f"{states_dir}/{n}/state{problem_num}"
                            ...
                            for line in solution_file:
                                ...
                                if match:
                                    ...
                                    if action in action_names and obj in object_names:
                                        print(f'Valid action found: applied action "{action}" to object {obj}')
                        ...
                        #     print(f"{solution_file_path} has been deleted.")
                        # except FileNotFoundError:
                        #     print(f"Error: {solution_file_path} not found.")
                        # try:
                        #     os.remove(state_file_path)
                        #     print(f"{state_file_path} has been deleted.")
                        # except FileNotFoundError:
